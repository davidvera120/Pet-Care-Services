   ...
   <span className="navbar-toggler-icon"></span>
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav position-absolute end-0 mx-3" Style="margin:10px;gap:12px;z-index:3; margin-right:50px;">
        ...
        <Link to="/homep" Style="text-decoration: none;color:rgb(0,70,148);"> <i className='bx bx-spreadsheet'  Style="font-size:25px;"></i></Link>
        </li>
        <li className="nav-item">
        <Link to="/vistamascota2" Style="text-decoration: none;color:rgb(0,70,148);"><i className='bx bx-file-find'  Style="font-size:25px;"></i></Link>
        </li>
        <li className="nav-item">
